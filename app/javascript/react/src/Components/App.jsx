...
import ElevatorMaintenanceGuide from "../Features/Blog/articles/ElevatorMaintenanceGuide";
...
const router = createBrowserRouter([
  ...
  { path: '/elevate-philly/maintenance-and-safety/elevator-maintenance-modernization-guide',element: <ElevatorMaintenanceGuide /> },
