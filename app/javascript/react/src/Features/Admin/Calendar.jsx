            ...
            <header className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none">
                ...
                <div className="flex items-center">
                    ...
                    <div className="hidden md:ml-4 md:flex md:items-center">
                        ...
                        <button
                            type="button"
                            className="ml-6 rounded-md bg-emerald-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600"
                        >
                            Add event
                        </button>
                    </div>
                                        ...
                                        {day.events.slice(0, 2).map((event) => (
                                            <li key={event.id}>
                                                <a href={event.href} className="group flex">
                                                    <p className="flex-auto truncate font-medium text-gray-900 group-hover:text-emerald-600">
                                                        {event.name}
                                                    </p>
                                                    <time
                                                        dateTime={event.datetime}
                                                        className="ml-3 hidden flex-none text-gray-500 group-hover:text-emerald-600 xl:block"
                                                    >
                                                        {event.time}
                                                    </time>
                                                </a>
